...
<div className=' py-[6%] pl-[12%]'>
  ...
  <h1 className='text-3xl font-bold pb-5'>Rental Bikes</h1>
  ...
  <Breadcrumbs>
    ...
    <NavLink href="#">All Bikes</NavLink>
  </Breadcrumbs>
...
<div>
      <h1  className='text-3xl font-bold pb-5 pt-[5%] text-center'>Bike Service</h1>
