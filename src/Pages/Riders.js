...
const Riders = () => {
  return (
    ...
    <div className=' py-[6%] pl-[12%]'>
      ...
      <h1 className='text-3xl font-bold pb-5'>Hire Drivers</h1>
      ...
      <Breadcrumbs>
        ...
        <NavLink href="#">All Drivers</NavLink>
      </Breadcrumbs>
    ...
    <div>
          <h1  className='text-3xl font-bold pb-5 pt-[5%] text-center'>Drivers List</h1>
                            ...
                            <Card>
                              ...
                              <CardBody>
                                  ...
                                  <i className="fa-solid fa-shopping-cart text-blue-900"></i>
                                    ...
                                    <NavLink to='/driver_details' className='rounded-full p-4 mx-4 hover:bg-white duration-500 text-green-700 hover:text-orange-700'>
